...
describe("Basic History Functions", () => {
  ...
  describe("addToHistory", () => {
    ...
    it("should limit the history size to the defined limit", () => {
      ...
      expect(mockStore.history.past[1].id).toBe("3");
      expect(mockStore.history.past[2].id).toBe("4");
  ...
  describe("redo", () => {
    ...
    it("should move the current state to past history", () => {
      ...
      expect(mockStore.history.past[pastLengthBefore].id).toBe("1");
    });
